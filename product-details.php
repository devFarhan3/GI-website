  ...
  <div class="ltn__breadcrumb-area text-left bg-dark bg-image  mb-0" data-bs-bg="img/offplans.webp">
      <div class="container">
          <div class="row">
              <div class="col-lg-9">
                  <div class="ltn__breadcrumb-inner">
                      <h1 class="page-title text-white">Property details</h1>

                  </div>
              </div>

              <div class="col-lg-3">
                  <div class="ltn__breadcrumb-list mt-lg-2">
                      <ul>
                          <li><a href="index.php"><span class="text-white">Home</span> </a></li>
                  ...
                  <div class="ltn__shop-details-inner ltn__page-details-inner mb-60">
                      <div class="ltn__blog-meta">
                          <ul>
                              ...
                              <li class="ltn__blog-category">
                                  <a class="bg-dark" href="#">For Rent</a>
                              </li>
                      ...
                      <label><span class="ltn__secondary-color"><i class="flaticon-pin"></i></span> Belmont Gardens,
                          Chicago</label>
                      ...
                      <p>To the left is the modern kitchen with central island, leading through to the unique breakfast
                          family room which feature glass walls and doors out onto the garden and access to the separate
                          utility room.</p>
                      ...
                      <div class="ltn__apartments-plan-area product-details-apartments-plan mb-60">
                          <div
                              ...
                              <div class="nav">
                                  ...
                                  <a class="active show" data-bs-toggle="tab" href="#liton_tab_3_2" class="">Second
                                      Floor</a>
                                                  ...
                                                  <div class="row">
                                                      <div class="col-lg-6">
                                                          <div
                                                              ...
                                                              <ul>
                                                                  <li><label>Total Area</label> <span>2800 Sq. Ft</span>
                                                                  </li>
                                                                  <li><label>Bedroom</label> <span>150 Sq. Ft</span>
                                                                  </li>
                                                              </ul>
                                                          </div>
                                                      </div>
                                                      <div class="col-lg-6">
                                                          <div
                                                              class="apartments-info-list apartments-info-list-color mt-40---">
                                                              <ul>
                                                                  <li><label>Belcony/Pets</label> <span>Allowed</span>
                                                                  </li>
                      ...
                      <div
                          ...
                          <div class="ltn__comment-reply-area ltn__form-box mb-30">
                              <form action="#">
                                  ...
                                  <label class="mb-0"><input type="checkbox" name="agree"> Save my name, email, and
                              ...
                              <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                                  ...
                                  <div class="product-info">
                                      ...
                                      <div class="product-img-location">
                                          <ul>
                                              <li>
                                                  <a href="product-details.php"><i class="flaticon-pin"></i> Belmont
                                                      Gardens, Chicago</a>
                                              </li>
                                          </ul>
                                      </div>
                  ...
                  <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                      ...
                      <div class="product-info">
                          ...
                          <div class="product-img-location">
                              <ul>
                                  <li>
                                      <a href="product-details.php"><i class="flaticon-pin"></i> Belmont Gardens,
                                          Chicago</a>
                                  </li>
                              </ul>
                          </div>
