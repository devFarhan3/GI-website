 ...
 <footer class="ltn__footer-area  ">
     <div class="footer-top-area  section-bg-9 plr--5">
             ...
             <div class="row">
                 <div class="col-xl-4 col-md-6 col-sm-6 col-12">
                     <div class="footer-widget footer-about-widget">
                         <div class="footer-logo">
                             <div class="site-logo">
                                 <img src="img/logo-black.png" alt="Logo" class="img-fluid">
                             </div>
                         </div>
                         <p>
                             Gi’s achievements are the result of Bold, Disciplined & Committed people gathered together,
                 ...
                 <div class="col-xl-2 col-md-6 col-sm-6 col-6">
                     <div class="footer-widget footer-menu-widget clearfix">
                         <h4 class="footer-title">GI Company</h4>
                         <div class="footer-menu">
                             <ul>
                                 <li><a href="buy.php">Buy</a></li>
                                 <li><a href="buy.php">Sell</a></li>
                                 <li><a href="#">Areas</a></li>
                                 <li><a href="#">About Us</a></li>
                                 <li><a href="contact.php">Contact Us</a></li>
                                 <li><a href="flybeforeyoubuy.php">Fly In </a></li>
                 ...
                 <!-- <div class="col-xl-2 col-md-6 col-sm-6 col-6">
                     <div class="footer-widget footer-menu-widget clearfix">
                         ...
                         <div class="footer-menu">
                             <ul>
                                 <li><a href="#">Property Investment Consultancy</a></li>
                                 <li><a href="property-management.php">Property Management</a></li>
                                 <li><a href="mortgages.php">Mortgage-Advisory</a></li>
                                 <li><a href="add-listing.php">Property Listing</a></li>
                                 <li><a href="mortgages.php">Holidays Homes</a></li>
                                 <li><a href="sellers-guide.php">Seller’s Guide</a></li>
                                 <li><a href="sellers-guide.php">Landlord’s Guide</a></li>
                             </ul>
                         </div>
                     </div>
                 </div> -->
                 <div class="col-xl-2 col-md-6 col-sm-6 col-6">
                     <div class="footer-widget footer-menu-widget clearfix">
                         ...
                         <div class="footer-menu">
                             <ul>
                                 <li><a href="#">All areas in Dubai</a></li>
                                 <li><a href="#">All areas in Abu Dhabi</a></li>
                                 <li><a href="#">All areas in Sharjah</a></li>
                                 <li><a href="#">All areas in Ras Al Khaimah</a></li>
                                 <li><a href="#">All areas in Dubai</a></li>
                                 <li><a href="#">All areas in Abu Dhabi</a></li>
                             </ul>
                         </div>
                 ...
                 <div class="col-xl-4 col-md-6 col-sm-12 col-12">
                     ...
                     <div class="footer-widget footer-newsletter-widget footer_center">
                             ...
                             <ul>
                                 <li>
                                     ...
                                     <div class="footer-address-info">
                                         <p>Office 702, Rooftop, Al Zarouni Business Centre Al Barsha 1, Dubai UAE</p>
                                     </div>
                                 </li>
                                 <li>
                                     <div class="footer-address-icon">
                                     ...
                                     <div class="footer-address-info">
                                         <p><a href="tel:+0123-456789"> +971 4 527 5800</a></p>
                                     </div>
                                 </li>
                                 <li>
                                     <div class="footer-address-icon">
                                     ...
                                     <div class="footer-address-info">
                                         <p><a href="mailto:info@giproperties.ae">info@giproperties.ae</a></p>
                                     </div>
                                 </li>
                             </ul>
                         </div>
             ...
             <div class="row">
                 <div class="col-md-6 col-12">
                     <div class="ltn__copyright-design clearfix">
                         <p>All Rights Reserved G.I Company <span class="current-year"></span></p>
                     </div>
                 </div>
                                 ...
                                 <div class="col-lg-6 col-12">
                                     <div class="modal-product-info">
                                         ...
                                         <label class="float-end mb-0"><a class="text-decoration"
                                                 href="product-details.html"><small>View Details</small></a></label>
                                     </div>
                                 </div>
                             </div>
                         </div>
    ...
    $('.nav-toggle').click(function() {
        ...
        $(collapse_content_selector).toggle(function() {
            if ($(this).css('display') == 'none') {
                ...
                toggle_switch.html('  Hide Search ');
            }
        });
    });
...
jQuery(function($) {
    $('a.sywh-open-services').click(function() {
        if ($('.sywh-services').hasClass('active')) {
            ...
            $('.sywh-services a:nth-child(2)').delay(100).fadeIn();
            $('.sywh-services a:nth-child(1)').delay(100).fadeIn();
        }
    });
});
