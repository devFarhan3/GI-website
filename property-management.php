...
<!-- __slide-item -->
<div class="ltn__slide-item pt-0 ltn__slide-item-2 ltn__slide-item-7 bg-image--- " data-bs-bg="img/slider/41.jpg">
                ...
                <div class="col-lg-12 align-self-center">
                    <div class="slide-item-car-dealer-form">
                        <div class="section-title-area ltn__section-title-2 text-center">
                            <h1 class="section-title  text-color-white">Property management service in Dubai</h1>
                                ...
                                <div class="tab-pane fade active show" id="ltn__form_tab_1_1">
                                    <div class="car-dealer-form-inner">
                                        <form action="#" class="ltn__car-dealer-form-box row">
                                            <div class="ltn__car-dealer-form-item ltn__custom-icon  col-lg-3 col-md-3">
                                                <div class="search">
                                            ...
                                            <div
                                                class="ltn__car-dealer-form-item ltn__custom-icon ltn__icon-house col-lg-2 col-md-3">
                                            ...
                                            <div
                                                class="ltn__car-dealer-form-item ltn__custom-icon ltn__icon-price col-lg-2 col-md-3">
                                                <select class="nice-select">
                                                    <option>Price Range</option>
                                                    <option>AED,5000</option>
                                                    <option>AED,5000</option>
                                                    <option>AED,5000</option>
                                                    <option>AED,5000</option>
                                                    <option> AED,5000</option>
                                            ...
                                            <div
                                                class="ltn__car-dealer-form-item ltn__custom-icon ltn__icon-price col-lg-3 col-md-3">
                                                <select class="nice-select">
            ...
            <div class="col-lg-6 align-self-center">
                <div class="about-us-info-wrap">
                    <div class="section-title-area ltn__section-title-2--- mb-20">
                        <h6 class="section-subtitle section-subtitle-2 ltn__secondary-color">Property Management in
                            Dubai</h6>
                        <h1 class="section-title">WE manage, so you don’t have to.<span>.</span></h1>
                        <p>
                            With an established track record from both past & present customers, White & Co Property
                            Management provide a bespoke service to each client, backed by experienced advisors who are
                            knowledgeable, passionate & dynamic about Dubai’s real estate Property Management.
                        </p>

                        <p>
                            Having a property manager is a hassle & stress-free way to maximise your ROI. It's a
                            one-stop shop of comprehensive service; from marketing, management, and everything in
                            between. We provide you with progress updates anywhere, anytime via a smart property
                            management portal and you get peace of mind knowing that your investment & tenants are in
                            good hands.
                        </p>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="btn-wrapper animated">
                                <a href="service.php" class="theme-btn-1 btn btn-effect-1 ">Download Brochure</a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="btn-wrapper animated">
                                <a href="team.php" class="theme-btn-2 btn btn-effect-2 ">Meet our Team</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="ltn__apartments-plan-area pt-115--- pb-70">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title-area ltn__section-title-2--- text-center">
                    <h6 class="section-subtitle section-subtitle-2 ltn__secondary-color">Be Inspired</h6>
                    <h1 class="section-title">Handpicked Properties</h1>
                </div>
                <div class="ltn__tab-menu ltn__tab-menu-3 ltn__tab-menu-top-right-- text-uppercase--- text-center">
                    <div class="nav">
                        <a data-bs-toggle="tab" class="active show" href="#liton_tab_3_1">For Sale</a>
                        <a data-bs-toggle="tab" href="#liton_tab_3_2">For Rent</a>
                        <a data-bs-toggle="tab" href="#liton_tab_3_3" class="">Holiday Homes</a>
                        <a data-bs-toggle="tab" href="#liton_tab_3_4" class="">Commercial</a>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="product-details.html"><i
                                                                        class="fas fa-camera"></i> 4</a>
                                                            </li>
                                                            <li>
                                                                <a href="product-details.html"><i
                                                                        class="fas fa-film"></i> 2</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ltn__product-item ltn__product-item-4 text-center---">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product-title"><a href="product-details.html">Modern
                                                        Apartments</a></h2>
                                                <div class="product-description">
                                                    <p>Beautiful Huge 1 Family House In Heart Of <br>
                                                        Westbury. Newly Renovated With New Wood</p>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ltn__product-item ltn__product-item-4 text-center---">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product-title"><a href="product-details.html">Comfortable
                                                        Apartment</a></h2>
                                                <div class="product-description">
                                                    <p>Beautiful Huge 1 Family House In Heart Of <br>
                                                        Westbury. Newly Renovated With New Wood</p>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ltn__product-item ltn__product-item-4 text-center---">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product-title"><a href="product-details.html">Luxury villa in
                                                        Rego Park </a></h2>
                                                <div class="product-description">
                                                    <p>Beautiful Huge 1 Family House In Heart Of <br>
                                                        Westbury. Newly Renovated With New Wood</p>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ltn__product-item ltn__product-item-4 text-center---">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product-title"><a href="product-details.html">Beautiful Flat
                                                        in Manhattan </a></h2>
                                                <div class="product-description">
                                                    <p>Beautiful Huge 1 Family House In Heart Of <br>
                                                        Westbury. Newly Renovated With New Wood</p>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="ltn__product-item ltn__product-item-4 text-center---">
                                                <div class="product-img">
                                                    ...
                                                    <div class="product-img-location-gallery">
                                                        <div class="product-img-location">
                                                            <ul>
                                                                <li>
                                                                    <a href="locations.html"><i
                                                                            class="flaticon-pin"></i> Belmont Gardens,
                                                                        Chicago</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <h2 class="product-title"><a href="product-details.html">New
                                        ...
                                        <div class="col-lg-12">
                                            <div class="ltn__product-item ltn__product-item-4 text-center---">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <h2 class="product-title"><a href="product-details.html">Luxury
                                                            villa in Rego Park </a></h2>
                                                    <div class="product-description">
                                                        <p>Beautiful Huge 1 Family House In Heart Of <br>
                                                            Westbury. Newly Renovated With New Wood</p>
                                                    </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="ltn__product-item ltn__product-item-4 text-center---">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <h2 class="product-title"><a href="product-details.html">Beautiful
                                                            Flat in Manhattan </a></h2>
                                                    <div class="product-description">
                                                        <p>Beautiful Huge 1 Family House In Heart Of <br>
                                                            Westbury. Newly Renovated With New Wood</p>
                                                    </div>
...
<div class="ltn__counterup-area section-bg-1 pt-100 pb-70">
    <div class="container">

        <div class="section-title-area ltn__section-title-2--- text-center">
            <h6 class="section-subtitle section-subtitle-2 ltn__secondary-color">G.I in numbers</h6>
            <h1 class="section-title">G.I are the Brightest and Fastest growing Real Estate Brokerage Firm in Dubai.
            </h1>
        </div>
        <div class="row">
            <div class="col-md-4 col-sm-6 align-self-center">
                <div class="ltn__counterup-item text-color-white---">
                    ...
                    <h1><span class="counter">160</span><span class="counterUp-icon">+</span> </h1>
                    <h6>property experts here to help</h6>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 align-self-center">
                <div class="ltn__counterup-item text-color-white---">
                    ...
                    <h1><span class="counter">4.5</span><span class="counterUp-letter">/5</span><span
                            class="counterUp-icon"></span> </h1>
                    <h6>Google rating from 560 Reviews</h6>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 align-self-center">
                <div class="ltn__counterup-item text-color-white---">
                    ...
                    <h1><span class="counter">3500</span><span class="counterUp-icon">+</span> </h1>
                    <h6>property transactions in 2022</h6>
                </div>
            </div>
...
<div class=" pt-100 pb-70">
    <div class="container">
        ...
        <div class="section-title-area ltn__section-title-2--- text-center">
            ...
            <h1 class="section-title">You’re in safe hands</h1>
        </div>
...
<div class=" pt-100 pb-70 section-bg-1">
    <div class="container">

        <div class="section-title-area ltn__section-title-2--- text-center">
            <h6 class="section-subtitle section-subtitle-2 ltn__secondary-color">Buying FAQs</h6>
            <h1 class="section-title">Still need help?</h1>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="ltn__faq-inner ltn__faq-inner-2">
                        ...
                        <div class="need-support text-center mt-100">
                            ...
                            <h3><i class="fas fa-phone"></i> +971 4 527 5800</h3>
                        </div>
                    </div>
                </div>
